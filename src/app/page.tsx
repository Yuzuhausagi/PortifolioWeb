...
export default function Home() {
  return (
    <main className="flex min-h-screen justify-center bg-slate-950">
      <NavBar />
      <div className="flex min-h-screen flex-col items-center justify-between p-4 sm:p-8 md:p-16 lg:p-24 gap-4 sm:gap-6 md:gap-8 w-full max-w-7xl">
        <section
          id="about"
        ...
        >
          ...
          <Terminal />
          <div className="mt-10 flex w-full flex-col items-center gap-4 sm:gap-6 md:gap-8">
            <TechnologyList />
          </div>
        </section>
        ...
        <Observer threshold={0.2}>
          ...
          >
            ...
            <div className="mx-auto flex w-full max-w-3xl flex-col gap-6 sm:gap-10">
              {/* Experience Item */}
              <div className="flex flex-col gap-3 rounded-xl border border-white/10 bg-slate-900/50 p-4 text-left sm:gap-4 sm:p-6">
                ...
                <ul className="list-outside list-disc space-y-2.5 pl-5 text-sm leading-relaxed text-slate-200 marker:text-teal-500/80 sm:text-base sm:leading-relaxed">
                  <li>
                    Guided over 100 students in developing basic and advanced
                    programming skills.
                  </li>
                  <li>
                    Collaborated with academic staff to provide tailored support
                    in debugging complex code, improving students&apos; learning
                    outcomes.
                  </li>
                </ul>
              </div>
              <div className="flex flex-col gap-3 rounded-xl border border-white/10 bg-slate-900/50 p-4 text-left sm:gap-4 sm:p-6">
                ...
                <ul className="list-outside list-disc space-y-2.5 pl-5 text-sm leading-relaxed text-slate-200 marker:text-teal-500/80 sm:text-base sm:leading-relaxed">
                  <li>
                    Developed a JavaScript Reddit bot for content moderation and
                    data analysis, enhancing user engagement and content
                    quality.
                  </li>
                  <li>
                    Created custom mods in C# for improving user experience and
                    security features in a Rust multiplayer environment.
                  </li>
                  <li>
                    Designed and implemented a Discord server admin bot using
                    JavaScript for automated moderation and enhanced security.
                  </li>
                  <li>
                    Leading development of the RapidCard language learning app
                    using Python, FastAPI, and web technologies, focusing on
                    interactive modules and user retention.
                  </li>
                </ul>
              </div>
              ...
              <div className="flex flex-col gap-3 rounded-xl border border-white/10 bg-slate-900/50 p-4 text-left sm:gap-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-teal-400">
                  Developer (Bachelor Project), Customs
                </h3>
                <span className="text-sm text-slate-300 sm:text-base">
                  Jan 2024 – May 2024
                </span>
                <ul className="list-outside list-disc space-y-2.5 pl-5 text-sm leading-relaxed text-slate-200 marker:text-teal-500/80 sm:text-base sm:leading-relaxed">
                  <li>
                    Led the development of a web application for managing
                    import/export requests in compliance with Norwegian customs
                    regulations.
                  </li>
                  <li>
                    Implemented AI-driven solutions to automate product
                    classification, optimize processing times, and reduce manual
                    workload.
                  </li>
                  <li>
                    Coordinated with cross-functional teams to adapt the
                    application to security, usability, and compliance
                    standards.
                  </li>
                </ul>
              </div>
              <div className="flex flex-col gap-3 rounded-xl border border-white/10 bg-slate-900/50 p-4 text-left sm:gap-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-teal-400">
                  Geenie Unity | Technical Support Specialist
                </h3>
                <span className="text-sm text-slate-300 sm:text-base">
                  Jan 2022 – Feb 2024
                </span>
                <ul className="list-outside list-disc space-y-2.5 pl-5 text-sm leading-relaxed text-slate-200 marker:text-teal-500/80 sm:text-base sm:leading-relaxed">
                  <li>
                    Provided technical support for web applications, enhancing
                    front-end performance and user experience by implementing
                    optimized CSS and JavaScript solutions.
                  </li>
                  <li>
                    Developed comprehensive user guides and documentation to
                    streamline support processes and improve customer
                    satisfaction.
                  </li>
                </ul>
              </div>

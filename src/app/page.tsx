    ...
    return (
        <main className="flex justify-center bg-slate-950">
            ...
            <div className="flex min-h-screen flex-col items-center justify-between p-24 gap-8" style={{width: 1700}}>
                ...
                <section id={"experience"} className="fkex flex-col gap-2">
                ...
                <section id={"contact"} className="flex flex-col gap-2">
                    ...
                    <div className="flex justify-center">
                          <a href="mailto:yosafzamir1998@gmail.com"  className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded " style={{ opacity: 1, transform: 'translateY(0px)'}}>
                          Contact me!
                    </a>
                    </div>
                </section>
